...
typedef enum {
  ...
  PROPERTY_USER_3,
  // I/O PINS
  PROPERTY_IO_CONFIG_PORTD,
  PROPERTY_IO_OUTPUT_PORTD,
  // OUTPUT MODE (Pusb-Pull or Open-Drain)
  PROPERTY_IO_OUTPUT_MODE_PORTA,
  PROPERTY_IO_OUTPUT_MODE_PORTB,
  PROPERTY_IO_OUTPUT_MODE_PORTC,
  PROPERTY_IO_OUTPUT_MODE_PORTD,
  // I2C DEFAULT CHANNEL SELECTION AND CLOCK SPEED
  PROPERTY_I2C_DEFAULT_CHANNEL,
  PROPERTY_I2C_CHAN0_CLK_LO,
  PROPERTY_I2C_CHAN0_CLK_HI,
  PROPERTY_I2C_CHAN1_CLK_LO,
  PROPERTY_I2C_CHAN1_CLK_HI,
  PROPERTY_I2C_CHAN2_CLK_LO,
  PROPERTY_I2C_CHAN2_CLK_HI,
...
//#define PROP_I2C_BYTE                     0x01
  ...
  #define PROP_I2C_AUTO_REDIRECT_A2_REQS  0x20
  #define PROP_I2C_RESERVED_FIELD         0xC0
